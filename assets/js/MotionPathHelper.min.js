...
function transformRawPath(t, e, n, i, s, a, o) {
  for (var r, h, l, c, d, u = t.length; - 1 < --u;) for (h = (r = t[u]).length, l = 0; l < h; l += 2) c = r[l],
    d = r[l + 1],
    r[l] = c * e + d * i + a,
    r[l + 1] = c * n + d * s + o;
  return t._dirty = 1,
...
function arcToSegment(t, e, n, i, s, a, o, r, h) {
  if (t !== r || e !== h) {
    ...
    var I, L = Math.ceil(U(O) / (g / 4)),
      ...
      z = d * -i,
      Y = c * i;
    for (I = 0; I < L; I++) _ = W(s = N + I * G),
      m = j(s),
      D = W(s += G),
      k = j(s),
      X.push(_ - B * m, m + B * _, D + B * k, k - B * D, D, k);
    for (I = 0; I < X.length; I += 2) _ = X[I],
      m = X[I + 1],
      X[I] = _ * q + m * z + E,
      X[I + 1] = _ * V + m * Y + M;
    return X[I - 2] = r,
...
function stringToRawPath(t) {
  ...
  var e, n, i, s, a, o, r, h, l, c, d, u, g, p, f, _ = (t + "").replace(S,
      function(t) {
        var e = +t;
  ...
  if (!t || !isNaN(_[0]) || isNaN(_[1])) return console.log(P),
    m;
  for (e = 0; e < y; e++) if (g = a, isNaN(_[e]) ? o = (a = _[e].toUpperCase()) !== _[e] : e--, i = +_[e + 1], s = +_[e + 2], o && (i += b, s += v), e || (h = i, l = s), "M" === a) r && (r.length < 8 ? --m.length: A += r.length),
    b = h = i,
    v = l = s,
    r = [i, s],
    m.push(r),
    ...
    (r = r || [0, 0]).push(i, s, b + 1 * _[e + 3], v + 1 * _[e + 4], b += 1 * _[e + 5], v += 1 * _[e + 6]),
    e += 6;
  else if ("S" === a) c = b,
    d = v,
  "C" !== g && "S" !== g || (c += b - r[r.length - 4], d += v - r[r.length - 3]),
  o || (b = v = 0),
    r.push(c, d, i, s, b += 1 * _[e + 3], v += 1 * _[e + 4]),
    e += 4;
  else if ("Q" === a) c = b + 2 / 3 * (i - b),
    d = v + 2 / 3 * (s - v),
  o || (b = v = 0),
    b += 1 * _[e + 3],
    v += 1 * _[e + 4],
    ...
    e += 4;
  else if ("T" === a) c = b - r[r.length - 4],
    d = v - r[r.length - 3],
    r.push(b + c, v + d, i + 2 / 3 * (b + 1.5 * c - i), s + 2 / 3 * (v + 1.5 * d - s), b = i, v = s),
    e += 2;
  else if ("H" === a) vd(b, v, b = i, v),
    e += 1;
  else if ("V" === a) vd(b, v, b, v = i + (o ? v - b: 0)),
    e += 1;
  else if ("L" === a || "Z" === a)"Z" === a && (i = h, s = l, r.closed = !0),
  ("L" === a || .5 < U(b - i) || .5 < U(v - s)) && (vd(b, v, i, s), "L" === a && (e += 2)),
    b = i,
    v = s;
  else if ("A" === a) {
    if (p = _[e + 4], f = _[e + 5], c = _[e + 6], d = _[e + 7], n = 7, 1 < p.length && (p.length < 3 ? (d = c, c = f, n--) : (d = f, c = p.substr(2), n -= 2), f = p.charAt(1), p = p.charAt(0)), u = arcToSegment(b, v, +_[e + 1], +_[e + 2], +_[e + 3], +p, +f, (o ? b: 0) + 1 * c, (o ? v: 0) + 1 * d), e += n, u) for (n = 0; n < u.length; n++) r.push(u[n]);
    b = r[r.length - 2],
      v = r[r.length - 1]
  } else console.log(P);
  return (e = r.length) < 6 ? (m.pop(), e = 0) : r[0] === r[e - 2] && r[1] === r[e - 1] && (r.closed = !0),
    m.totalPoints = A + e,
    m
}
function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
  var d, u = (t + n) / 2,
    ...
    x = U((n - o) * C - (i - r) * S),
    E = U((s - o) * C - (a - r) * S);
  return l || (l = [t, e, o, r], c = 2),
    l.splice(c || l.length - 2, 0, P, w),
  h * (S * S + C * C) < (x + E) * (x + E) && (d = l.length, bezierToPoints(t, e, u, g, b, v, P, w, h, l, c), bezierToPoints(P, w, y, A, _, m, o, r, h, l, c + 2 + (l.length - d))),
    l
}
function pointsToSegment(t, e, n) {
  ...
  for (isNaN(n) && (n = Math.PI / 10), x && (t.push(A, P), A = v, P = y, v = t[b - 2], y = t[b - 1], t.unshift(v, y), b += 4), e = e || 0 === e ? +e: 1, h = 2; h < b; h += 2) i = v,
    s = y,
    v = A,
    y = P,
    A = +t[h + 2],
    P = +t[h + 3],
  v === A && y === P || (f = (l = S) * l + (d = C) * d, _ = (S = A - v) * S + (C = P - y) * C, m = (c = A - i) * c + (u = P - s) * u, p = (a = Math.acos((f + _ - m) / Z(4 * f * _))) / Math.PI * e, g = Z(f) * p, p *= Z(_), v === i && y === s || (n < a ? (r = E(u, c), w.push(o(v - W(r) * g), o(y - j(r) * g), o(v), o(y), o(v + W(r) * p), o(y + j(r) * p))) : (r = E(d, l), w.push(o(v - W(r) * g), o(y - j(r) * g)), r = E(C, S), w.push(o(v), o(y), o(v + W(r) * p), o(y + j(r) * p)))));
  return v !== A || y !== P || w.length < 4 ? w.push(o(A), o(P), o(A), o(P)) : w.length -= 2,
  ...
  return d.push(parseFloat(t[u]), parseFloat(t[1 + u])),
    function simplifyStep(t, e, n, i, s) {
      var a, o, r, h, l, c, d, u, g, p, f, _, m = i,
        ...
        y = t[n],
        A = t[n + 1];
      for (o = e + 2; o < n; o += 2) h = t[o],
        l = t[o + 1],
        p = void 0,
        _ = (g = A) - (d = v),
      ((f = (u = y) - (c = b)) || _) && (1 < (p = ((h - c) * f + (l - d) * _) / (f * f + _ * _)) ? (c = u, d = g) : 0 < p && (c += f * p, d += _ * p)),
...
function getClosestProgressOnBezier(t, e, n, i, s, a, o, r, h, l, c, d, u, g) {
  var p, f, _, m, b = (s - i) / a,
    v = 0,
    y = i;
  for (A = P; y <= s;)(p = (f = (m = 1 - y) * m * m * o + 3 * m * m * y * h + 3 * m * y * y * c + y * y * y * u - e) * f + (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * g - n) * _) < A && (A = p, v = y),
    y += b;
  return 1 < t ? getClosestProgressOnBezier(t - 1, e, n, Math.max(v - b, 0), Math.min(v + b, 1), a, o, r, h, l, c, d, u, g) : v
}
function C(t) {
  var e = t.ownerDocument || t; ! (D in t.style) && "msTransform" in t.style && (k = (D = "msTransform") + "Origin");
...
function K(t, e) {
  if (t.parentNode && (g || C(t))) {
    ...
    return e && (n ? (v = v || K(t), h.setAttribute("width", .01), h.setAttribute("height", .01), h.setAttribute("transform", "translate(" + a + "," + o + ")"), v.appendChild(h)) : (u || ((u = K(t)).style.cssText = r), h.style.cssText = r + "width:0.1px;height:0.1px;top:" + o + "px;left:" + a + "px", u.appendChild(h))),
      h
  }
...
function N(t, e) {
  ...
  if (c.length || c.push(K(t, 1), K(t, 2), K(t, 3)), n = h ? v: u, h) l ? (a = -(s = function _getCTM(t) {
    var e, n = t.getCTM();
    return n || (e = t.style[D], t.style[D] = "none", t.appendChild(x), n = x.getCTM(), t.removeChild(x), e ? t.style[D] = e: t.style.removeProperty(D.replace(/([A-Z])/g, "-$1").toLowerCase())),
      n
  } (t)).e / s.a, o = -s.f / s.d, i = y) : (s = t.getBBox(), a = (i = (i = t.transform ? t.transform.baseVal: {}).numberOfItems ? 1 < i.numberOfItems ?
    function _consolidate(t) {
      for (var e = new R,
             n = 0; n < t.numberOfItems; n++) e.multiply(t.getItem(n).matrix);
      return e
    } (i) : i.getItem(0).matrix: y).a * s.x + i.c * s.y, o = i.b * s.x + i.d * s.y),
  e && "g" === t.tagName.toLowerCase() && (a = o = 0),
    (l ? h: d).appendChild(n),
    n.setAttribute("transform", "matrix(" + i.a + "," + i.b + "," + i.c + "," + i.d + "," + (i.e + a) + "," + (i.f + o) + ")");
  else {
    if (a = o = 0, M) for (i = t.offsetParent, s = t; (s = s && s.parentNode) && s !== i && s.parentNode;) 4 < (f.getComputedStyle(s)[D] + "").length && (a = s.offsetLeft, o = s.offsetTop, s = 0);
    if ("absolute" !== (r = f.getComputedStyle(t)).position && "fixed" !== r.position) for (i = t.offsetParent; d && d !== i;) a += d.scrollLeft || 0,
      o += d.scrollTop || 0,
      d = d.parentNode; (s = n.style).top = t.offsetTop - o + "px",
...
function getGlobalMatrix(t, e, n, i) {
  ...
  var s = function _forceNonZeroScale(t) {
      for (var e, n; t && t !== b;)(n = t._gsap) && n.uncache && n.get(t, "x"),
  ...
  if (c.removeChild(o), s) for (r = s.length; r--;)(h = s[r]).scaleX = h.scaleY = 0,
...
function Ga(t, e, n) {
  var i = e.vars[t];
  return i && i.call(e.vars.callbackScope || e, n || e),
    e
}
function Ia() {
...
function La(t) {
  ...
  this._matrix = this.target.transform.baseVal.getItem(0).matrix,
    this._ctm = s,
    V[t.type] ? (e = -1 !== t.type.indexOf("touch") ? t.currentTarget || t.target: L, Aa(e, "touchend", i._onRelease), Aa(e, "touchmove", i._onMove), Aa(e, "touchcancel", i._onRelease), Aa(L, "touchstart", Ea), Aa(c, "touchforcechange", ma)) : (e = null, Aa(L, "mousemove", i._onMove)),
  h || Aa(L, "mouseup", i._onRelease),
    ...
    1 === this._ctm.a && 0 === this._ctm.b && 0 === this._ctm.c && 1 === this._ctm.d ? this._ctm = null: (n = i._startPointerX * this._ctm.a + i._startPointerY * this._ctm.c + this._ctm.e, i._startPointerY = i._startPointerX * this._ctm.b + i._startPointerY * this._ctm.d + this._ctm.f, i._startPointerX = n),
    i.isPressed = nt = !0,
...
function Na(t, e) {
  var n = this;
  if (n._enabled && n.isPressed && (!t || null == n.touchID || e || !(t.pointerId && t.pointerId !== n.touchID || t.changedTouches && !
    ...
    return a && !o && n.vars.onDragRelease ? n.vars.onDragRelease.call(n, n.pointerEvent) : (a && ma(a), n.vars.onRelease && n.vars.onRelease.call(n.vars.callbackScope || n, n.pointerEvent)),
...
function Oa(t, e, n, i) {
  ...
  return a.closed && (r[0].isClosedStart = !0),
    r
}
function Pa(t, e, n) {
  var i = t[n] - t[e],
...
var L, h, c, r, l, X, G, d, B, q, V, z, Y, n, $ = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
  ...
  ht = ((n = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
    ...
    this.snap && !G && (st.x = s, st.y = a, this.snap.call(this, st), s = st.x, a = st.y),
    this.x === s && this.y === a || (this._matrix.f = this.y = a, this._matrix.e = this.x = s, !this.isDragging && this.isPressed && (this.isDragging = !0, Ga("onDragStart", this, this.pointerEvent)))
  },
...
var lt, ct = ((lt = Anchor.prototype).onPress = function onPress() {
  ...
  lt.update = function update(t, e, n) {
    ...
    this.segment = s,
      this.smooth = 0 < n && n < s.length - 2 && Math.abs(Math.atan2(s[n + 1] - s[1 + a], s[n] - s[a]) - Math.atan2(s[n + 3] - s[n + 1], s[n + 2] - s[n])) < .09 ? 2 : 0,
...
var dt, ut = ((dt = PathEditor.prototype)._onRelease = function _onRelease(t) {
  ...
  dt.init = function init() {
    ...
    if (a && this._anchors && this._anchors.length) {
      for (e = 0; e < this._anchors.length; e++) this._anchors[e].element.parentNode.removeChild(this._anchors[e].element),
        this._anchors[e]._draggable.enabled(!1);
      this._selectedAnchors.length = 0
    }
    if (this._rawPath = i, a) {
      if (this._anchors = Oa(i, 0, this, o), 1 < (t = i.length)) for (e = 1; e < t; e++) this._anchors = this._anchors.concat(Oa(i, e, this, o))
    ...
    return this._selection.appendChild(this._handle1),
      ...
      this._g.setAttribute("transform",
        function _getConcatenatedTransforms(t) {
          for (var e = qa(t), n = t.ownerSVGElement; (t = t.parentNode) && t.ownerSVGElement === n;) e.multiply(qa(t));
    ...
    if ("hidden" === this._selection.style.visibility) this.select();
      ...
      for (this._draggable && this._draggable._onRelease(t), l && (s = t.clientX * l.a + t.clientY * l.c + l.e, a = t.clientX * l.b + t.clientY * l.d + l.f), r = function getClosestData(t, e, n, i) {
        var s, a, o, r, h = {
          ...
          l = P;
        for (a = 0; a < t.length; a++) for (r = t[a], s = 0; s < r.length; s += 6) o = getClosestProgressOnBezier(1, e, n, 0, 1, i || 20, r[s], r[s + 1], r[s + 2], r[s + 3], r[s + 4], r[s + 5], r[s + 6], r[s + 7]),
        ...
        return h
             ...
             function subdivideSegment(t, e, n) {
               ...
               return d += (_ - d) * n,
                 g += (m - g) * n,
                 t.splice(e + 2, 4, o(c), o(u), o(p), o(f), o(p + (d - p) * n), o(f + (g - f) * n), o(d), o(g), o(_), o(m)),
  ...
  dt.select = function select(t) {
    ...
    return - 1 === rt.indexOf(this) && rt.push(this),
      this._updateAnchors(),
      this
  },
  ...
  dt._onPressAnchor = function _onPressAnchor(t) { - 1 === this._selectedAnchors.indexOf(t) ? (G || (this._selectedAnchors.length = 0), this._selectedAnchors.push(t)) : G && (this._selectedAnchors.splice(this._selectedAnchors.indexOf(t), 1), t._draggable.endDrag()),
    i.x = t.segment[t.i],
    i.y = t.segment[t.i + 1],
    this._updateAnchors(),
    Ga("onPress", this)
  ...
  dt._updateAnchors = function _updateAnchors() {
    ...
    i && (this._handle1.setAttribute("d", i.smooth ? this._circleHandle: this._squareHandle), this._handle2.setAttribute("d", i.smooth ? this._circleHandle: this._squareHandle)),
      t = i ? i.i: 0,
      i && (t || i.isClosedStart) ? (e = i.isClosedStart ? s[s.length - 4] : s[t - 2], n = i.isClosedStart ? s[s.length - 3] : s[t - 1], this._handle1.style.visibility = this._line1.style.visibility = X || e !== s[t] || n !== s[t + 1] ? "visible": "hidden", this._handle1.setAttribute("transform", "translate(" + e + ot + n + ")"), this._line1.setAttribute("points", e + ot + n + ot + s[t] + ot + s[t + 1])) : this._handle1.style.visibility = this._line1.style.visibility = "hidden",
      i && t < s.length - 2 ? (e = s[t + 2], n = s[t + 3], this._handle2.style.visibility = this._line2.style.visibility = X || e !== s[t] || n !== s[t + 1] ? "visible": "hidden", this._handle2.setAttribute("transform", "translate(" + e + ot + n + ")"), this._line2.setAttribute("points", s[t] + ot + s[t + 1] + ot + e + ot + n)) : this._handle2.style.visibility = this._line2.style.visibility = "hidden"
  },
  ...
  dt._onPressHandle1 = function _onPressHandle1() {
    this._editingAnchor.smooth && (this._oppositeHandleLength = Pa(this._editingAnchor.segment, this._editingAnchor.i, this._editingAnchor.i + 2)),
      Ga("onPress", this)
  },
  dt._onPressHandle2 = function _onPressHandle2() {
    this._editingAnchor.smooth && (this._oppositeHandleLength = Pa(this._editingAnchor.segment, this._editingAnchor.isClosedStart ? this._editingAnchor.segment.length - 4 : this._editingAnchor.i - 2, this._editingAnchor.i)),
      Ga("onPress", this)
  },
  ...
  dt._onDragHandle1 = function _onDragHandle1() {
    ...
    n[s] = o = (o * a | 0) / a,
      n[1 + s] = r = (r * a | 0) / a,
    e.smooth && (X ? (e.smooth = !1, e.element.setAttribute("d", this._squareHandle), this._handle1.setAttribute("d", this._squareHandle), this._handle2.setAttribute("d", this._squareHandle)) : (t = Math.atan2(n[i + 1] - r, n[i] - o), o = this._oppositeHandleLength * Math.cos(t), r = this._oppositeHandleLength * Math.sin(t), n[i + 2] = ((n[i] + o) * a | 0) / a, n[i + 3] = ((n[i + 1] + r) * a | 0) / a)),
      this.update()
  },
  dt._onDragHandle2 = function _onDragHandle2() {
    ...
    n[i + 2] = o = (o * a | 0) / a,
      n[i + 3] = r = (r * a | 0) / a,
    e.smooth && (X ? (e.smooth = !1, e.element.setAttribute("d", this._squareHandle), this._handle1.setAttribute("d", this._squareHandle), this._handle2.setAttribute("d", this._squareHandle)) : (t = Math.atan2(n[i + 1] - r, n[i] - o), o = this._oppositeHandleLength * Math.cos(t), r = this._oppositeHandleLength * Math.sin(t), n[s] = ((n[i] + o) * a | 0) / a, n[1 + s] = ((n[i + 1] + r) * a | 0) / a)),
      this.update()
  },
  dt._onDragAnchor = function _onDragAnchor(t, e, n) {
    var i, s, a, o, r, h = this._selectedAnchors,
      l = h.length,
      c = 1e3;
    for (s = 0; s < l; s++) i = (o = h[s]).i,
      a = o.segment,
      i ? (a[i - 2] = ((a[i - 2] + e) * c | 0) / c, a[i - 1] = ((a[i - 1] + n) * c | 0) / c) : o.isClosedStart && (a[r = a.length - 2] = ta(a[r] + e), a[1 + r] = ta(a[1 + r] + n), a[r - 2] = ta(a[r - 2] + e), a[r - 1] = ta(a[r - 1] + n)),
      a[i] = ((a[i] + e) * c | 0) / c,
      a[i + 1] = ((a[i + 1] + n) * c | 0) / c,
    i < a.length - 2 && (a[i + 2] = ((a[i + 2] + e) * c | 0) / c, a[i + 3] = ((a[i + 3] + n) * c | 0) / c),
    o !== t && o.element.setAttribute("transform", "translate(" + a[i] + ot + a[i + 1] + ")");
    this.update()
  },
  dt.enabled = function enabled(t) {
    ...
    this._draggable && this._draggable.enabled(t),
      t ? this._selection.parentNode || (this.path.ownerSVGElement.appendChild(this._selectionHittest), this.path.ownerSVGElement.appendChild(this._selection), this.init(), this._saveState()) : (this.deselect(), this.path.ownerSVGElement.removeChild(this._selectionHittest), this.path.ownerSVGElement.removeChild(this._selection)),
      this._updateAnchors(),
      this.update()
  },
  dt.update = function update(t) {
    ...
    return this.vars.onUpdate && this._enabled && Ga("onUpdate", this, o),
      this
  },
  ...
  dt.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
    var s, a, o, r, h, l, c = this._rawPath[0],
      ...
      p = 1 / (c[g - 2] + d),
      f = -t || c[g - 1] + u;
    for (f = f ? 1 / f: -p, p *= 1e3, f *= 1e3, a = at.length = 0; a < g; a += 2) at[a] = ((c[a] + d) * p | 0) / 1e3,
      at[a + 1] = ((c[a + 1] + u) * f | 0) / 1e3;
    if (i) {
      for (s = [], g = at.length, a = 2; a < g; a += 6) o = at[a - 2],
        r = at[a - 1],
        h = at[a + 4],
        l = at[a + 5],
        s.push(o, r, h, l),
        bezierToPoints(o, r, at[a], at[a + 1], at[a + 2], at[a + 3], h, l, .001, s, s.length - 2);
...
function PathEditor(t, e) {
  ...
  function _initCore() {
    ...
    r && r.appendChild(z),
      V = function(t) {
        for (var e = t.split(","), n = (void 0 !== q.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel": void 0 !== q.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel": t).split(","), i = {},
               s = 4; - 1 < --s;) i[e[s]] = n[s],
          i[n[s]] = e[s];
        return i
      ...
      L.addEventListener("keydown",
        function(t) {
          ...
          else if ("Alt" === o || 18 === a) for (X = !0, e = rt.length; - 1 < --e;) rt[e]._onPressAlt();
          ...
          } else if ("Delete" === o || "Backspace" === o || 8 === a || 46 === a || 63272 === a || "d" === a && (l || d)) for (e = rt.length; - 1 < --e;) rt[e]._deleteSelectedAnchors();
          else if (("a" === o || 65 === a) && (d || l)) for (e = rt.length; - 1 < --e;) rt[e].select(!0)
        },
        !0),
  ...
  for (var s = [this._handle1, this._handle2, this._line1, this._line2, this._selection, this._selectionPath, this._selectionHittest], a = s.length; - 1 < --a;) s[a]._gsSelection = !0; ! 1 !== e.draggable && (this._draggable = new ht(this._selectionHittest, {
    callbackScope: this,
    onPress: this.select,
    onRelease: this._onRelease,
  ...
  !1 !== e.selected && (this.path._gsSelection = !0, rt.push(this)),
    this._saveState(),
  h || (Aa(this._selectionHittest, "mousedown", Fa(this._onClickSelectionPath, this)), Aa(this._selectionHittest, "mouseup", Fa(this._onRelease, this))),
...
ut.simplifyPoints = simplifyPoints,
  ...
  ut.simplifySVG = function(t, e) {
    ...
    if (d = (e = e || {}).tolerance || 1, c = e.precision || 1 / d, g = (void 0 === e.cornerThreshold ? 18 : +e.cornerThreshold) * J, "string" != typeof t && (t = (n = t).getAttribute("d")), "#" !== t.charAt(0) && "." !== t.charAt(0) || (n = L.querySelector(t)) && (t = n.getAttribute("d")), i = !1 !== e.curved || /[achqstvz]/gi.test(t) ? stringToRawPath(t)[0] : t.match($), !1 !== e.curved) {
      for (l = i, i = [], u = l.length, s = 2; s < u; s += 6) a = +l[s - 2],
        r = +l[s - 1],
        o = +l[s + 4],
        h = +l[s + 5],
        i.push(ta(a), ta(r), ta(o), ta(h)),
        bezierToPoints(a, r, +l[s], +l[s + 1], +l[s + 2], +l[s + 3], o, h, 1 / (2e5 * c), i, i.length - 2); (i = pointsToSegment(simplifyPoints(i, d), e.curviness, g))[2] = "C" + i[2]
...
function mb(t, e, n) {
  return fb(t) ? ft.querySelector(t) : Array.isArray(t) ? yt(vt([{
...
function rb(t, e) {
  ...
  pt = window,
    ...
    (bt = gt && gt.plugins.motionPath) ? (function _initCopyToClipboard() { (At = gb("textarea")).style.display = "none",
      mt.appendChild(At)
...
function MotionPathHelper(t, e) {
  ...
  l && !i && (i = mb(l.vars.motionPath.path || l.vars.motionPath, n, l.vars.motionPath)),
    ...
    f.style.cssText = "border-radius:8px; background-color:rgba(85, 85, 85, 0.7); color:#fff; cursor:pointer; padding:6px 12px; font-family:Signika Negative, Arial, sans-serif; position:fixed; left:50%; transform:translate(-50%, 0); font-size:19px; bottom:10px",
  ...
  "anchorSnap" in e || (e.anchorSnap = function(t) {
  ...
  e.center && gt.set(n, {
    ...
    p.parent !== gt.globalTimeline && gt.globalTimeline.add(p,
      function _getGlobalTime(t) {
        for (var e = t.totalTime(); t;) e = t.startTime() + e / (t.timeScale() || 1),
          t = t.parent;
        return e
